...
export function RentVsBuyAnalysis({ propertyValue, monthlyRent }: RentVsBuyAnalysisProps) {
    ...
    return (
      <Card className="flex flex-col items-center justify-center py-16 text-center gap-3">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm max-w-xs">
          Introduce el{" "}
          <strong className="text-slate-700 dark:text-slate-200">alquiler actual o estimado</strong>{" "}
          en el perfil financiero para calcular la rentabilidad bruta y el análisis de comprar vs.
          alquilar.
        </p>
      </Card>
    );
  ...
  if (grossYield < 3) {
    ...
    yieldDescription =
      "La rentabilidad es muy baja. Financieramente suele ser mejor alquilar e invertir tus ahorros en otros activos.";
    ...
    yieldDescription =
      "Rentabilidad estándar en el mercado actual. La decisión de compra dependerá más de factores personales que puramente financieros.";
    ...
    yieldDescription =
      "Buena rentabilidad. La compra empieza a ser una opción financieramente muy atractiva frente al alquiler.";
  } else {
    ...
    yieldDescription =
      "Excelente rentabilidad implícita. Comprar esta propiedad es financieramente mucho más ventajoso que alquilarla.";
  }
    ...
    <div className="space-y-6">
      <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-800 rounded-none p-4 flex gap-3 text-blue-800 dark:text-blue-300">
        ...
        <div className="text-sm">
          <strong>Consejo:</strong> Para que este análisis sea preciso, el alquiler introducido en
          los datos de la hipoteca debe corresponder a una <strong>propiedad equivalente</strong>{" "}
          (mismas características, metros cuadrados, zona y estado de conservación).
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card
          className={`lg:col-span-2 flex flex-col justify-center border-l-4 ${yieldBorderColor}`}
        >
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
            <div className="text-center md:text-left shrink-0">
              ...
              <div
                className={`inline-block px-3 py-1 rounded-none text-sm font-semibold border ${yieldBg} ${yieldColor}`}
              >
                {yieldCategory}
              </div>
            </div>
      ...
      <Card>
        ...
        <div className="relative pt-8 pb-2">
          ...
          {/* Marcas */}
          <div className="absolute top-2 left-[30%] -translate-x-1/2 text-xs font-semibold text-slate-500 dark:text-slate-400">
            3%
          </div>
          <div className="absolute top-2 left-[50%] -translate-x-1/2 text-xs font-semibold text-slate-500 dark:text-slate-400">
            5%
          </div>
          <div className="absolute top-2 left-[70%] -translate-x-1/2 text-xs font-semibold text-slate-500 dark:text-slate-400">
            7%
          </div>
