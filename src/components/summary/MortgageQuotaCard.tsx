        ...
        <div className="flex gap-2">
          {monthlyIncome > 0 && (
            <div className="relative group cursor-help">
              <div
                className={`text-xs px-2 py-0.5 rounded-none ${effortColor} border border-white/10`}
              >
          ...
          <div className="text-indigo-200 text-xs bg-indigo-500/40 px-2 py-0.5 rounded-none">
            {years} años
          </div>
        </div>
      </div>
